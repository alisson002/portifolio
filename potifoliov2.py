...
# ============================================================
# Base: #0077D4 (azul primário), #475569 (cinza escuro),
...
if ESCURO:
    T = {
        ...
        "sidebar_card_bg": "rgba(255, 255, 255, 0.04)",
        "sidebar_card_border": "rgba(255, 255, 255, 0.06)",
        "contato_hover": "rgba(0, 119, 212, 0.12)",
        "contato_bg": "rgba(255, 255, 255, 0.03)",
        "titulo_cor": "#f1f5f9",
        "texto_cor": "#cbd5e1",
        "desc_cor": "#94a3b8",
        "card_bg": "#0f1d32",
        "card_border": "#1e293b",
        "card_hover_shadow": "rgba(0, 119, 212, 0.15)",
        "card_nome_cor": "#f1f5f9",
        "card_desc_cor": "#94a3b8",
        "tag_bg": "#1e293b",
        "tag_cor": "#94a3b8",
        "header_border": "#1e293b",
        "placeholder_repo": "#0d1b2e",
        "placeholder_dash": "#0b1e1a",
        "dash_card_border": "rgba(0, 119, 212, 0.2)",
        "rodape_border": "#1e293b",
        "rodape_cor": "#64748b",
        "toggle_label": "☀️ Tema Claro",
    }
else:
    T = {
        "primaria": "#0077D4",
        ...
        "card_nome_cor": "#06101b",
        "card_desc_cor": "#757491",
        "tag_bg": "#e2e8f0",
        "tag_cor": "#475569",
        "header_border": "#e2e8f0",
        "placeholder_repo": "#e8f0fe",
        "placeholder_dash": "#ecfdf5",
        "dash_card_border": "rgba(0, 119, 212, 0.15)",
        "rodape_border": "#e2e8f0",
        "rodape_cor": "#757491",
        "toggle_label": "🌙 Tema Escuro",
    }
...
<style>
    ...
    .sidebar-nome {{
        ...
        font-size: 1.5rem;
        font-weight: 700;
        color: {T["sidebar_strong"]} !important;
    ...
    .sidebar-sobre {{
        background: {T["sidebar_card_bg"]};
        border-radius: 10px;
        padding: 1rem 1.1rem;
        border: 1px solid {T["sidebar_card_border"]};
    ...
    .contato-item {{
        ...
        border-radius: 8px;
        background: {T["contato_bg"]};
        margin-bottom: 0.45rem;
        transition: all 0.2s ease;
        text-decoration: none !important;
    }}
    .contato-item:hover {{
        background: {T["contato_hover"]};
    ...
    .hero-descricao {{
        max-width: 700px;
        background-color: {"#111c2e" if ESCURO else "#edf2f7"};
        border-left: 4px solid {T["primaria"]};
    ...
    .card:hover {{
        box-shadow: 0 8px 30px {T["card_hover_shadow"]};
    ...
    .card-nome {{
        font-size: 1.15rem;
        font-weight: 700;
        color: {T["card_nome_cor"]};
        margin-bottom: 0.5rem;
    }}
    .card-desc {{
        font-size: 0.85rem;
        color: {T["card_desc_cor"]};
        line-height: 1.6;
        flex: 1;
    }}
    .card-link {{
    ...
    .card.dash-card {{
        border: 1px solid {T["dash_card_border"]};
    }}
    ...
    .rodape {{
        ...
        padding: 2rem 0;
        margin-top: 4rem;
        border-top: 1px solid {T["rodape_border"]};
        color: {T["rodape_cor"]};
        font-size: 0.75rem;
        letter-spacing: 1px;
    }}
...
def gerar_card_repo(projeto: dict) -> str:
    ...
    preview = gerar_preview(projeto["repo_img"], T["placeholder_repo"], "💻")
    return f"""
...
def gerar_card_dash(projeto: dict) -> str:
    ...
    preview = gerar_preview(projeto["dash_img"], T["placeholder_dash"], "📊")
    return f"""
...
with st.sidebar:
    # Botão de alternar tema no topo da sidebar
    st.button(T["toggle_label"], on_click=alternar_tema, use_container_width=True)
        ...
        <style>
            * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }}
            ...
            .contato-item {{
                ...
                background: {T["contato_bg"]}; cursor: pointer;
                transition: all 0.2s ease; text-decoration: none; position: relative;
            }}
            .contato-item:hover {{ background: {T["contato_hover"]}; transform: translateX(3px); }}
            .contato-icone {{
            ...
            .contato-label {{
                ...
                letter-spacing: 1px; color: #757491; line-height: 1; margin-bottom: 2px;
            }}
            .contato-valor {{ font-size: 0.82rem; color: {T["sidebar_text"]}; }}
            .copiado-badge {{
